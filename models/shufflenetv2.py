...
class ShuffleNetV2(nn.Module):
    def __init__(self, output_dim=128, sample_size=112, width_mult=1., pre_train=False):
        ...
        self.conv_head = nn.Conv3d(self.stage_out_channels[-1], 512, kernel_size=1, bias=False)   #in order to encode the image to vector with the same size to the resnet 18
